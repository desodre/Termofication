...
class AppColors {
  ...
  static const Color unknown = Color(0xFF818384);   // Cinza médio (não descoberto)
  ...
  static const Color borderDefault = Color(0xFF3A3A3C); // Borda de células vazias
  static const Color borderActive = Color(0xFF565758);  // Borda de células ativas
